...
async function updateOrderTransaction(req, res) {
    ...
    try {
        ...
        const subContent = data.status == 'Completed' ? 'You order is on processed and will be shipped to you. <br>Thank you for shopping!' : `Unfortunately, your order was declined due to: "${data.remarks}". <br>    Sorry for the inconvenience and thank you!`
